...
import controller.DoanhThu_Controller;
...
public class TrangChu_View extends JFrame {
	...
	public JButton btn_Xoa_ThongKe;
	private JButton btn_TimKiem_ThongKe;
	public JButton btn_Loc;
	public JTextField txt_DoanhThuNgay;
	private JTable table_DoanhThuNgay;
	public JTextField txt_DoanhThuThang;
	private JTable table_DoanhThuThang;
	public JTextField txt_DoanhThuNam;
	private JTable table_DoanhThuNam;
	public JButton btn_DoanhThuNgay;
	public JButton btn_DoanhThuThang;
	public JButton btn_DoanhThuNam;
	private DefaultTableModel model_HangHoa;
	private DefaultTableModel model_HangHoaThanhToan;
	public DefaultTableModel model_HangHoaLoc;
	public DefaultTableModel model_DoanhThuNgay;
	public DefaultTableModel model_DoanhThuThang;
	public DefaultTableModel model_DoanhThuNam;
	...
	public JComboBox comboBox_Loc;
	public JLabel text_Ngay;
	public JLabel lbl_TienDoanhThuNgay;
	public JLabel text_Thang;
...
//
		...
		ThongKe_Controller tKC = new ThongKe_Controller(this);
		btn_TimKiem_ThongKe = new JButton("Tìm kiếm");
		btn_TimKiem_ThongKe.addMouseListener(tKC);
		...
		btn_Xoa_ThongKe.addMouseListener(tKC);
		...
		DoanhThu_Controller dTC = new DoanhThu_Controller(this);
		btn_DoanhThuNgay = new JButton("Thống kê");
		btn_DoanhThuNgay.addMouseListener(dTC);
		...
		btn_DoanhThuThang.addMouseListener(dTC);
		...
		btn_DoanhThuNam.addMouseListener(dTC);
